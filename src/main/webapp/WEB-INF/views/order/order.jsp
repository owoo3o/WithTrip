        ...
        <div class="row m-0">
            ...
            <div class="col-lg-5 p-0 ps-lg-4">
               ...
               <div class="col-sm-13">
                    ...
                    <br>
<!--                         <div class="row bg-light m-0" style="border-radius: 8px;"> -->
<!--                             <div class="col-12 px-4 my-4" > -->
<!--                                 <p class="fw-bold">카드결제</p> -->
<!--                             </div> -->
<!--                             <div class="col-12 px-4"> -->
<!--                                 <div class="d-flex  mb-4"> -->
<!--                                     <span class=""> -->
<!--                                         <p class="text-muted">카드번호</p> -->
<!--                                         <input class="form-control" type="text" value="" -->
<!--                                             placeholder="1234 5678 9012 3456"> -->
<!--                                     </span> -->
<!--                                     <div class=" w-100 d-flex flex-column align-items-end"> -->
<!--                                         <p class="text-muted">Expires</p> -->
<!--                                         <input class="form-control2" type="text" value="" placeholder="MM/YYYY"> -->
<!--                                     </div> -->
<!--                                 </div> -->
<!--                                 <div class="d-flex mb-5"> -->
<!--                                     <span class="me-5"> -->
<!--                                         <p class="text-muted">카드 소유자 이름</p> -->
...
// 	            amount : 150000,
	            ...
	            receipt_url : null
           }, function(rsp){ // callback 함수  (-->다른 함수의 인자로써 넘겨진 후 특정 이벤트에 의해 호출되는 함수)
	            	...
	            	// 결제 검증 및 결제(DB 저장 포함)
	      			$.ajax({
						...
						console.log(data.response.amount);
	      	        	...
	      	        	// 위의 rsp.paid_amount 와 data.response.amount를 비교한후 결제 로직 실행 (iamport 서버 검증)
				        if(rsp.paid_amount == data.response.amount){
				                 ...
				                 var result = {
									...
									"zipCode" : postcode,
									"shipNo" : 'shipNo_' + new Date().getTime(),
				                 ...
				                 $.ajax({
				                    ...
				                    data : JSON.stringify(result,
				                          ['phone', 'orderNo', 'price', 'recipient', 'shipNo', 'orderAddress', 'zipCode', 'card_no', 'orderStatus', 'email', 'goodsId', 'payNO','approvalNo', 'receiptUrl']),
				                    contentType : 'application/json;charset=utf-8',
				                    success: function(res) {	// 결제 및 DB 저장 성공 시 data==1 / 실패 시  0
...
// 						              			alert("결제 및 결제검증완료");
	      	        	...
	      	        	} else {	// iamport 서버 검증에 만족하지 못 했을 때
	      	        		alert("검증 실패");
	      	        	}
	      	        });
...
//               } else { // 결제 실패 시 
// //                  var msg = "결제에 실패하였습니다.";
//                  var msg = "결제 및 검증에 실패하였습니다.";
//                  msg += '에러남' + rsp.error_msg; 
//                  console.log(msg);
//               }
